...
- **THEN** the system reports Claude Code project, OpenCode user, and Cline user as missing
...
- **THEN** the system includes Claude Code user/project, OpenCode user/project, and Cline user in the comparison
